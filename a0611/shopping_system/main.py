import csv
from services.order_service import read_orders, calculate_customer_totals, calculate_product_quantities, calculate_product_revenue
from views.report_view import print_total_per_customer, print_product_quantities, print_product_revenues
